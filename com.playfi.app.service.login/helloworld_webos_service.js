...
// Start Audio Capture
service.register("getAudioData", function (message) {
  console.log(logHeader, "SERVICE_METHOD_CALLED:/startAudioRecording");
  console.log("adarsh AUDIO FILE READ START");
  try {
    audioDataBuffer = fs.readFileSync("./sample.wav");

    console.log("adarsh AUDIO FILE READ DONE");

    audioDataBase64 = audioDataBuffer.toString("base64");
