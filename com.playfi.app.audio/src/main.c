...
// This service name
#define SERVICE_NAME "com.playfi.app.audio"
#define BUF_SIZE 64
...
LSMethod sampleMethods[] = {
    {"echo", echo},   // luna://com.playfi.app.audio/echo
};


/*
 * Define luna://com.playfi.app.audio/echo
 *  - A method that always returns the same value
 *
 * +----------------------------+            +--------------------------------+
 * |   com.sample.echo          |            | com.playfi.app.audio        |
 * |   Foreground Application   |            |        Background Service      |
 * +----------------------------+            +--------------------------------+
 *   |                                                                        |
 *   |                                                                        |
 *   | 1. Request to luna://com.playfi.app.audio/echo                      |
